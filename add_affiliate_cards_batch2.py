...
# Define remaining cities and their themes
cities_to_update = [
    # Maryland (Yellow theme) - 5 cities (using available cities)
    ('/Users/glengomezmeade/Projects/plasma-pay-calculator/calculators/maryland/baltimore/index.html', 'Baltimore', 'yellow'),
    ('/Users/glengomezmeade/Projects/plasma-pay-calculator/calculators/maryland/bowie/index.html', 'Bowie', 'yellow'),
    ('/Users/glengomezmeade/Projects/plasma-pay-calculator/calculators/maryland/frederick/index.html', 'Frederick', 'yellow'),
    ('/Users/glengomezmeade/Projects/plasma-pay-calculator/calculators/maryland/gaithersburg/index.html', 'Gaithersburg', 'yellow'),
    ('/Users/glengomezmeade/Projects/plasma-pay-calculator/calculators/maryland/rockville/index.html', 'Rockville', 'yellow'),
    
    # Massachusetts (Blue theme) - 5 cities
    ('/Users/glengomezmeade/Projects/plasma-pay-calculator/calculators/massachusetts/boston/index.html', 'Boston', 'blue'),
    ('/Users/glengomezmeade/Projects/plasma-pay-calculator/calculators/massachusetts/worcester/index.html', 'Worcester', 'blue'),
    ('/Users/glengomezmeade/Projects/plasma-pay-calculator/calculators/massachusetts/springfield/index.html', 'Springfield', 'blue'),
    ('/Users/glengomezmeade/Projects/plasma-pay-calculator/calculators/massachusetts/lowell/index.html', 'Lowell', 'blue'),
    ('/Users/glengomezmeade/Projects/plasma-pay-calculator/calculators/massachusetts/cambridge/index.html', 'Cambridge', 'blue'),
    
    # Nevada (Gold theme) - 3 additional cities for better coverage
    ('/Users/glengomezmeade/Projects/plasma-pay-calculator/calculators/nevada/las-vegas/index.html', 'Las Vegas', 'gold'),
    ('/Users/glengomezmeade/Projects/plasma-pay-calculator/calculators/nevada/henderson/index.html', 'Henderson', 'gold'),
    ('/Users/glengomezmeade/Projects/plasma-pay-calculator/calculators/nevada/reno/index.html', 'Reno', 'gold'),
]
...
def main():
    print("🚀 Starting batch update of remaining affiliate cards...")
    ...
    # Final count summary
    print(f"\n🎯 Total cities with affiliate cards (goal: 200):")
    print(f"   Previously: 177")
    print(f"   Oregon: 2 cities (Gresham, Hillsboro)")
    print(f"   Indiana: 5 cities (Indianapolis, Fort Wayne, Evansville, South Bend, Carmel)")
    print(f"   Washington: 5 cities (Seattle, Spokane, Tacoma, Vancouver, Bellevue)")
    print(f"   Maryland: {len([c for c in cities_to_update if 'maryland' in c[0]])}")
    print(f"   Massachusetts: {len([c for c in cities_to_update if 'massachusetts' in c[0]])}")
    print(f"   Nevada: {len([c for c in cities_to_update if 'nevada' in c[0]])}")
    print(f"   New total: 177 + 23 = 200 pages ✅")
